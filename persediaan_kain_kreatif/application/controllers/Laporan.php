...
class Laporan extends CI_Controller
{
    ...
    private function _cetak($data, $table_, $tanggal)
    {
        ...
        if ($table_ == 'barang_masuk') :
            ...
            $pdf->Cell(55, 7, 'corak_kain', 1, 0, 'C');
            ...
            foreach ($data as $d) {
                ...
                $pdf->Cell(35, 7, $d['id_kain_masuk'], 1, 0, 'C');
                $pdf->Cell(55, 7, $d['corak_kain'], 1, 0, 'L');
            ...
            $pdf->Cell(50, 7, 'corak_kain', 1, 0, 'C');
            $pdf->Cell(30, 7, 'customer', 1, 0, 'C');
            $pdf->Cell(30, 7, 'marketing', 1, 0, 'C');
            ...
            foreach ($data as $d) {
                ...
                $pdf->Cell(30, 7, $d['id_kain_keluar'], 1, 0, 'C');
                $pdf->Cell(50, 7, $d['corak_kain'], 1, 0, 'L');
                $pdf->Cell(30, 7, $d['nama_customer'], 1, 0, 'L');
                $pdf->Cell(30, 7, $d['marketing'], 1, 0, 'L');
