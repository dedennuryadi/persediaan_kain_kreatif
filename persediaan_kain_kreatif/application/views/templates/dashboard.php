...
<head>
    ...
    <title><?= $title; ?> | Persediaan Kain Dep.Kreatif</title>
        ...
        <ul class="navbar-nav bg-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseMaster" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    ...
                    <?php if (is_admin()) : ?>
                        <a class="collapse-item" href="<?= base_url('supply'); ?>">Supplier Greige</a>
                        <a class="collapse-item" href="<?= base_url('satuan'); ?>">Satuan Kain</a>
                        <a class="collapse-item" href="<?= base_url('jenis'); ?>">Jenis Benang</a>
                        <a class="collapse-item" href="<?= base_url('customer'); ?>">Customer</a>
                        <?php endif; ?>
                        <a class="collapse-item" href="<?= base_url('barang'); ?>">Data Stok Barang</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar title-->
                    <a class="sidebar-brand d-flex text-primary align-items-center  justify-content-center" href="">
                    <div class="sidebar-brand-icon">
                        <i class="fas fa-database"></i>
                    </div>
                    <div class="sidebar-brand-text mx-3"><b>APLIKASI PERSEDIAAN KAIN DEPARTEMEN KREATIF</b></div>
                    </a>
            ...
            <footer class="sticky-footer bg-light">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Aplikasi Persediaan Kain Di Departemen Kreatif  &bull; by <?= anchor('deden'); ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
