<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card shadow-sm border-bottom-primary">
            ...
            <div class="card-body">
                    <label class="col-md-3 text-md-right" for="id_barang">Corak Kain</label>
                    <div class="col-md-9">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-md-9">
                        <input value="<?= set_value('corak_kain'); ?>" name="corak_kain" id="corak_kain" type="text" class="form-control" placeholder="corak kain...">
